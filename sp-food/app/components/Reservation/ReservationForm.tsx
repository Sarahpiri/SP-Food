...
const ReservationForm = () => {
  return (
    <div className="bg-green-700 p-6 rounded-lg">
      ...
      <p className="text-[20px] uppercase md:text-[25px] text-white font-semibold text-center">
        Book your table
      </p>
      {/* {inputs} */}
      <div className="mt-[2rem]">
       ...
       justify-between space-x-4"
        >
          <select
            className="px-10 py-2.5 bg-transparent rounded-lg outline-none font-bold 
        text-[17px] text-white border-[2.2px] border-gray-100"
          ...
          <input type="date" className="px-10 py-2.5 bg-transparent rounded-lg outline-none font-bold text-[17px]
          text-white border-[2.2px] border-gray-100"/>
        </div>
        <input type="time" className="px-10 py-2 bg-transparent block w-[80%] mx-auto mt-[1rem] rounded-lg outline-none
